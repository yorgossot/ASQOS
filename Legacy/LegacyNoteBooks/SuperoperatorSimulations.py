...
class Simulation():
    ...
    def Create_Parameter_Dict(self):  
        ...
        g_f_val = g
        g0_val  = g
        v_val   =  g*sg.sqrt(kappa_b_val/gamma_val)   # c=C :        g*sg.sqrt(kappa_b_val/gamma_val)
    ...
    def Numerical_Substitution(self):   
        ...
        self.eff_hamiltonian_C =  substitute(self.eff_hamiltonian) 
    ...
    def Run_Simulations(self,start,end,n, maximize_fidelity = True,equate_losses= False ):
        ...
        for (C_val_i,C_val) in enumerate(self.C_val_range):      
            ...
            eff_hamiltonian_num = self.eff_hamiltonian_C.subs(g=g_val).expand() 
